...
export class SquareType {
  ...
  private static itemsData: [string, [string, string]][] = [
    ...
    ['gh', ['ClipboardStand.png', 'Clipboard Stand']],
    ...
    ['NV', ['eggs.png', 'Eggs']],
    ['Tl', ['ExtraCakeStand.png', 'Cake Stand']],
    ['Ls', ['fish.png', 'Fish']],
    ['AG', ['flour.png', 'Flour']],
    ['xn', ['Garlic.png', 'Garlic']],
    ['Fr', ['Honey.png', 'Honey']],
    ['B9', ['HostingStand.png', 'Hosting Stand']],
    ['1D', ['hot-dog-buns.png', 'Hotdog Buns']],
    ['Sx', ['hot-dogs.png', 'Hotdogs']],
    ['K4', ['Ice.png', 'Ice']],
    ['xQ', ['IceDispenser.png', 'Ice Dispenser']],
    ['vu', ['ice-cream.png', 'Ice Cream']],
    ['uS', ['Jalapeños.png', 'Jalapeños']],
    ...
    ['uW', ['meat.png', 'Meat']],
    ['mL', ['Milk.png', 'Milk']],
    ['U1', ['MilkSteamer.png', 'MilkSteamer']],
